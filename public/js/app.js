...
angular.module('komon.services', ['komon.constants', 'ui.bootstrap']);
angular.module('komon.controllers', ['komon.services', 'ngAnimate', 'mwl.bluebird']);
angular.module('komon.directives', []);

var app = angular.module('komon', ['komon.controllers', 'komon.services', 'komon.directives', 'ngRoute', 'ngAnimate']).
